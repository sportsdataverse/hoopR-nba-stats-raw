#!/usr/bin/env bash
# Per-period boxscores. Period count comes from each game's persisted playbyplayv3.
#
# Stage 12 of the NBA stats raw pipeline. Every stage is independently
...
PYTHONUNBUFFERED=1 PYTHONIOENCODING=utf-8 "$PY" python/nba_stats_03_period_boxscores.py "$SEASONS"
