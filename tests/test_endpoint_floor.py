...
import pytest
from nba_stats_raw_scrape._capture_runtime import ENDPOINT_MIN_SEASON, _skip_endpoint
...
def test_gamerotation_defaults_to_parked() -> None:
    ...
    src = (
        ...
        " import nba_stats_raw_scrape._capture_runtime as s;"
...
def test_no_duplicate_endpoint_keys() -> None:
    ...
    src = (Path(__file__).resolve().parent.parent / "python" / "nba_stats_raw_scrape" / "_capture_runtime.py").read_text(
        encoding="utf-8"
    )
...
def test_no_false_ceilings() -> None:
    ...
    from nba_stats_raw_scrape._capture_runtime import ENDPOINT_MAX_SEASON
